...
export default function WhiteNav() {
  ...
  return (
    <div className="fixed   m-auto w-full h-18 z-50">
      <nav className="bg-white  border-0 border-b-2 border-gray-100 max-w-7xl m-auto py-1">
        <div className="navbar container m-auto ">
          <div className="navbar-start">
            ...
            <Link to="/" className="font-bold text-black px-2 lg:text-2xl">
              Gadget-H
            </Link>
          </div>
          ...
          <div className="navbar-end ">
            <Link to="/dashboard/cart" className="mr-4  bg-white rounded-full ">
            ...
            <Link to="/dashboard/wishlist" className="mr-2  bg-white  rounded-full ">
              <button className="indicator cursor-pointer bg-white rounded-full p-2">
                <span className="indicator-item px-1 badge badge-secondary">
                  +{cartItems.length}
                </span>
